            ...
            <div class="col-lg-5 col-sm-12 ">
                <div class="card bg-bright-dark-accent" style="border:none; border-radius: 30px;">
                    <form action="" class="bg-bright-dark-accent px-4 py-2"  style="border:none; border-radius: 25px;" method="POST">
                        ...
                        <div class="row g-4 p-2" style="border:none;">
                            <div class="col-lg-12">
                                <h2 class="display-6 text-white pb-2" style="font-size: 2em; font-weight: 300; ">Please fill up the form for Guest 3</h2>
                                <input type="text" name="phase_4_fname"  class="form-control py-2" placeholder="First Name" maxlength="25" >
                            </div>
                            <div class="col-lg-12">
                                <input type="text" name="phase_4_mname" class="form-control py-2" placeholder="Middle Name" maxlength="25">
                            </div>
                            <div class="col-lg-12">
                                <input type="text" name="phase_4_lname" class="form-control py-2" placeholder="Last Name" maxlength="25">
                            </div>
                            <div class="col-lg-12">
                                <input placeholder="Date of birth" class="form-control py-2"  name="phase_4_bday" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" id="date" />
                            </div>
                            <div class="col-lg-12">
                                <!-- lagyan ito ng max input hanggang 10 lang at 0 lagi ang umpisa  -->
                                <input type="number" name="phase_4_cnum" class="form-control py-2" placeholder="Contact Number" maxlength="13"> 
                            </div>
                            <div class="col-lg-12">
                                <input type="email"  name="phase_4_email" class="form-control py-2" placeholder="Email" maxlength="25">
                            </div>
                    
                        </div>
                                <input type="submit" class="btn btn-pink text-white text-center w-50 py-2 mb-2" name="phase4_submit" value="Register">
