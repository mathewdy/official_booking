                    ...
                    <div class="card-body bg-bright-dark-accent" style="border:none;">
                        <form action="" method="POST">
                            <div class="row p-4 gy-4">
                                <div class="col-lg-12">
                                    <input type="text" class="form-control" name="admin" placeholder="Username" maxlength="25">
                                </div>
                                <div class="col-lg-12">
                                    <input type="password" class="form-control" name="password" placeholder="Password" maxlength="25">
                                </div>
                                <div class="col-lg-12">
                                    <input type="submit" class="btn btn-info-dark py-2 text-white w-100" name="login" value="Login">
                                </div>
